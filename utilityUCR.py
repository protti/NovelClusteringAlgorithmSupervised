...
# Funzione che restituisce la distanza fra due indici
...
# Funzione che restituisce l'appartenenza di un indice ad un determinato cluster
...
# Faccio una lista degli indici che si ripetono in una determinata lista
# Utilizzato affinche si possano inizializzare gli indici per la scelta dei centroidi
...
# Crea una lista di valori che rappresentano l'apparteneza di un indice ad un determinato cluster
# restituisce dei dizionari che hanno come chiave l'indice del centroide selezionato
...
def getInitialIndex(dictTotal,cluster):
    # Scorro tutte le chiavi sommando le loro distanze
    listOfMinDist = list()
    listOfMinId = list()
